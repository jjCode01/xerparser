...
class SchedCalendar(BaseModel):
    ...
    def __eq__(self, __o: "SchedCalendar") -> bool:
        ...
        """
        return self.clndr_name == __o.clndr_name and self.clndr_type == __o.clndr_type

    def __hash__(self) -> int:
        """
        Return a hash representation of a Calendar object.
        """
        return hash((self.clndr_name, self.clndr_type))

    def __str__(self) -> str:
        """
        Return a string representation of a Calendar object.
        """
        return f"{self.clndr_name} [{self.type}]"
    ...
    def type(self) -> str:
        ...
        return CALENDAR_TYPES[self.clndr_type]
